...
public class Patient_login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblphoto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Patient login.jpg"))); // NOI18N
        ...
        jLabel5.setText("LOGIN TO PATIENT PORTAL");
    ...
    private void btnloginjButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnloginjButton1ActionPerformed
        ...
        try {
            ...
            String sql = "Select username, password from Accountforpatient where username = ? and password = ?";
            PreparedStatement pst = cn.prepareStatement(sql);
            pst.setString(1, txtid1.getText());
            pst.setString(2, txtpass1.getText());
